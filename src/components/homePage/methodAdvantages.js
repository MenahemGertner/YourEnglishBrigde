  ...
  const solutions = [
    {
      ...
      description: "מסלול מדויק של 2,500 המילים השימושיות ביותר באנגלית, מחולקות ל-5 רמות מובנות. המטרה היא, שבסיום המסלול תדע להשתמש בפועל בכל אחת מהמילים שלמדת."
    },
    {
